...
describe("RetrieveComment", async () => {
  it("should render correctly", async () => {
    const { container } = render(<RetrieveComment />)

    const titleElements = container.querySelectorAll("h1")
    const expectedTitles = ["Retrieve a comment"]
    ...
    const expectedCodeboxes = ["Response", "GET/api/comments/:id"]
