...
describe("ListComments", async () => {
  it("should render correctly", async () => {
    const { container } = render(<ListComments />)

    const titleElements = container.querySelectorAll("h1")
    const expectedTitles = ["List all comments"]
    ...
    const expectedSubtitles = ["Query parameters", "Returns"]
    ...
    const expectedCodeboxes = ["Response", "GET/api/comments"]
